...
import br.edu.ifpe.pdm.cardapiolanches.bean.PedidoItem;
...
public class PedidoItemDAO {
    ...
    public PedidoItemDAO(Context context){
        ...
        Log.v(MY_TAG, "PedidoItemDao Build");
   ...
   /* private SQLiteDatabase getDb() {
    ...
    public void open() throws SQLException {
        ...
        db = helper.getWritableDatabase();
        //  db.execSQL("DROP TABLE IF EXISTS PedidoItem" );
        //  helper.onCreate(db);
        //onUpgrade(db,0,1);
    ...
    public void close()
    {
        Log.v(MY_TAG, "Close Database PedidoItemDAO");
        helper.close();
    }
